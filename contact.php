...
<head>
    ...
    <link rel="stylesheet" href="css/contant_style.css"/>
...
<section>
    ...
    <ul class="full_menu_list">
        <li class="menu_item"><a href="home.php">Portfolio</a></li>
        <li class="menu_item"><a href="steet.php">Street</a></li>
        <li class="menu_item"><a href="travel.php">Travel</a></li>
        <li class="menu_item"><a href="portait.php">Portait</a></li>
        <li class="menu_item"><a href="about.php">About</a></li>
        <li class="menu_item"><a href="contact.php">Contact</a></li>
    ...
    <div class="contact">
        <div class="contact_list">
            <form method="POST" action="contact-form-handler.php">
                ...
                <div class="forms_fields">
                    <textarea class="input_fields" placeholder="Message" required="" name="message"></textarea>
                </div>
                <div class="forms_fields">
